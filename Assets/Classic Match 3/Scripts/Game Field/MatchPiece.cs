...
public class MatchPiece : MonoBehaviour
{
    ...
    // Add tile to an global tiles array
	...
	private void CheckDrag(Vector2 position)
	{
		...
		else if (down) dir = SwapDirection.DOWN;
        else if (left) dir = SwapDirection.LEFT;
        else if (right) dir = SwapDirection.RIGHT;
